...
export const settings: Setting[] = (
	[
		...
		{
			category: "Teams",
			key: "minorLeagueMaxRosterSize",
			name: "Minor League Max Roster Size",
			godModeRequired: "always",
			type: "int",
			descriptionLong: (
				<>
					<p>
						Currently only used in hockey. This controls the maximum number
						of players who can be assigned to a team's minor league roster.
						Minor league players do not count against your active roster
						size limits and cannot play in games, but their salaries still
						count against your salary cap.
					</p>
					<p>Set to 0 to disable the minor league roster feature entirely.</p>
				</>
			),
			validator: (value) => {
				if (value < 0) {
